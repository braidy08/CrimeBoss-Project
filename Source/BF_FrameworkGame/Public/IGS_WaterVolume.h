...
private:
    ...
    bool EncompassesPoint(FVector Point, float SphereRadius, float* OutDistanceToPoint) override {return false;};
    FPostProcessVolumeProperties GetProperties() const override {PURE_VIRTUAL(AIGS_WaterVolume::GetProperties); return FPostProcessVolumeProperties();};
};
