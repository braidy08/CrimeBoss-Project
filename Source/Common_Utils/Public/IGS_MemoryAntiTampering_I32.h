...
public:
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FIGS_EncryptedI32 Sub3(UPARAM(Ref) FIGS_EncryptedI32& EncryptedInt, int32& Result, int32 int_);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FIGS_EncryptedI32 Sub1(UPARAM(Ref) FIGS_EncryptedI32& EncryptedInt, int32& Result, int32 int_);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static bool NotEqual2(UPARAM(Ref) FIGS_EncryptedI32& EncryptedIntA, UPARAM(Ref) FIGS_EncryptedI32& EncryptedIntB);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static bool NotEqual1(UPARAM(Ref) FIGS_EncryptedI32& EncryptedInt, UPARAM(Ref) int32& int_);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FIGS_EncryptedI32 Mul3(UPARAM(Ref) FIGS_EncryptedI32& EncryptedInt, int32& Result, int32 int_);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FIGS_EncryptedI32 Mul1(UPARAM(Ref) FIGS_EncryptedI32& EncryptedInt, int32& Result, int32 int_);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FIGS_EncryptedI32 Mod3(UPARAM(Ref) FIGS_EncryptedI32& EncryptedInt, int32& Result, int32 int_);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FIGS_EncryptedI32 Mod1(UPARAM(Ref) FIGS_EncryptedI32& EncryptedInt, int32& Result, int32 int_);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static bool LessEqual2(UPARAM(Ref) FIGS_EncryptedI32& EncryptedIntA, UPARAM(Ref) FIGS_EncryptedI32& EncryptedIntB);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static bool LessEqual1(UPARAM(Ref) FIGS_EncryptedI32& EncryptedInt, UPARAM(Ref) int32& int_);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static bool Less2(UPARAM(Ref) FIGS_EncryptedI32& EncryptedIntA, UPARAM(Ref) FIGS_EncryptedI32& EncryptedIntB);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static bool Less1(UPARAM(Ref) FIGS_EncryptedI32& EncryptedInt, UPARAM(Ref) int32& int_);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static bool GreaterEqual1(UPARAM(Ref) FIGS_EncryptedI32& EncryptedInt, UPARAM(Ref) int32& int_);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static bool Greater2(UPARAM(Ref) FIGS_EncryptedI32& EncryptedIntA, UPARAM(Ref) FIGS_EncryptedI32& EncryptedIntB);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static bool Greater1(UPARAM(Ref) FIGS_EncryptedI32& EncryptedInt, UPARAM(Ref) int32& int_);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static bool Equal2(UPARAM(Ref) FIGS_EncryptedI32& EncryptedIntA, UPARAM(Ref) FIGS_EncryptedI32& EncryptedIntB);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static bool Equal1(UPARAM(Ref) FIGS_EncryptedI32& EncryptedInt, UPARAM(Ref) int32& int_);
    
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FIGS_EncryptedI32 Encrypt2(const int32& int_);
    
    UFUNCTION(BlueprintCallable)
    static FIGS_EncryptedI32 Encrypt1(const int32& int_);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FIGS_EncryptedI32 Div3(UPARAM(Ref) FIGS_EncryptedI32& EncryptedInt, int32& Result, int32 int_);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FIGS_EncryptedI32 Div1(UPARAM(Ref) FIGS_EncryptedI32& EncryptedInt, int32& Result, int32 int_);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FIGS_EncryptedI32 Assign1(UPARAM(Ref) FIGS_EncryptedI32& EncryptedInt, const int32 int_, int32& Value);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FIGS_EncryptedI32 Add3(UPARAM(Ref) FIGS_EncryptedI32& EncryptedInt, int32& Result, int32 int_);
    ...
    UFUNCTION(BlueprintCallable, BlueprintPure)
    static FIGS_EncryptedI32 Add1(UPARAM(Ref) FIGS_EncryptedI32& EncryptedInt, int32& Output, int32 int_);
